...
if(strpos($_SERVER['HTTP_USER_AGENT'], 'Chrome') !== false)	$navigateur = 'Chrome';
...
include('basetpl.php');
$smarty->assign('index_logo', $site['logo_index']);
$smarty->assign('navigateur', $navigateur);
$smarty->assign('index_vid', $site['top_video']);
$smarty->assign('index_vid_desc', $site['vid_desc']);
$smarty->assign('list2', $list2);
$smarty->assign('list3', $list3);

$smarty->display('templates/defaut/index.tpl');
echo $copyright;
mysql_close();
?>