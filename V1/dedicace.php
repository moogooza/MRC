...
if(isset($_SESSION['username']))
{
	...
	if(isset($_POST['message']))
	{
		...
		{
			$sql = "INSERT INTO radio_dedicaces (pseudo, message, temps) VALUES('".mysql_real_escape_string(htmlspecialchars(ucfirst($_SESSION['username'])))."', '".mysql_real_escape_string(htmlspecialchars($_POST['message']))."', ".time().")";
...
$smarty->assign('postmess', $_POST['message']);

$smarty->display('templates/defaut/dedicace.tpl');
echo $copyright;
mysql_close();
?>